...
Future<File> generatePdfFile(DocItem document, BusinessProfile profile) async {
  ...
  final fontBytes = await File('/System/Library/Fonts/Supplemental/Arial Unicode.ttf').readAsBytes();
    ...
    pw.MultiPage(
      ...
      build: (_) => [
        ...
        pw.Row(
          mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
          children: [
            pw.Text('Generated by BillBee', style: pw.TextStyle(fontSize: 9, color: muted)),
